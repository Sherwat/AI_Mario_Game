...
{
  GameStatus = "start";
  document.getElementById("status").innerHTML = "Game Loaded! Enjoy"
}
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Start to Play the Game", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function jumping(character){
	if((noseY < 350 &&character.live) || (touchIsDown&&character.live) ){
    mario_jump.play();
